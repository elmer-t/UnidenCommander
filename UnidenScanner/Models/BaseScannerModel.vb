    ...
    Public Class BaseScannerModel
        ...
        Public Sub Connect()
            ...
            Try
                ...
                Me.Connection.Timeout = Me.ConnectionTimeout
...
#Region " Scanner state properties "
        ...
        Private _PriorityChannel As Boolean
        ...
        End Sub
        Protected Friend Sub SetLockOut(ByVal value As Boolean)
            _LockOut = value
            RaiseEvent PropertyChanged(Properties.LockOut)
        End Sub
        ...
        End Sub
        Protected Friend Sub SetPriorityChannel(ByVal value As Boolean) ' Implements IScannerModel.SetPriorityScan
            _PriorityChannel = value
            RaiseEvent PropertyChanged(Properties.PriorityChannel)
        End Sub
        ...
        Public ReadOnly Property Muted() As ScannerBoolean ' Implements IScannerModel.Muted
            ...
            End Get
        End Property
        Public ReadOnly Property PriorityChannel() As Boolean ' Implements IScannerModel.PriorityScan
            Get
